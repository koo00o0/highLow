	...
	function getCon(){
		$.ajax({
			...
			data : {
				...
				CKEDITOR.instances.ckeditor.setData(obj[0]);
				$('#blogContent').val(obj[0]);
				$('#title').val(obj[1]);
				$('#userId').text(obj[2]);
				$('#resultSeq').val("${vo.getSeq()}");
			}
		})
	}
...
<body>
<div style='display:none' id='bobobo'></div>
<img class="logo" src="${path}/resources/images/noticeimg/logo.png" alt="하루방">
<form action="/updateBlog" method="post" id="blogForm">
	<div class="topClass">
    ...
    <input type="button" id="ckeditor" class='insertBtn w-btn w-btn-indigo' name="ckeditor" value="저장" onclick="checkWrite()">
</div>
</form>
</body>
</html>