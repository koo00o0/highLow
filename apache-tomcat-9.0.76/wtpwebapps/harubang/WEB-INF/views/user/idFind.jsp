...
<script>
   ...
   function idFind() {   
      if ($("#name").val() == "") {
         var nameMs="";
         nameMs = "<p class='Mas'>* 이름을 입력해주세요. </p>"
         $(".nameMass").html(nameMs);
         $("#name").focus();
         return;
      }
      if ($("#email").val() == "") {
      ...
      document.getElementById("idFind").submit();
   }
</script>
</head>
<body>
    <div class="class">
        ...
        <form action="/idFind" method="POST" id="idFind">
            <br/>
            <h3>아이디 찾기</h3>
            <div class="itemBox">
            ...
            <div class="nameMass emailMass phoneMass"></div>
